...
namespace VRCSDK2.Validation
{
    public static class WorldValidation
    {
        ...
        {
            #if UNITY_STANDALONE
                "VRC.SDK3.Components.VRCMidiNoteIn",
                "VRC.SDK3.Components.scripts.Scenes.VRCPanorama",
            #endif
            "VRC.SDK3.Components.VRCAudioBank",
            "VRC.SDK3.Components.VRCIKFollower",
            "VRC.SDK3.VRCCombatSystem",
            "VRC.SDK3.VRCDestructibleStandard",
            "VRC.SDK3.Components.VRCVisualDamage",
            "VRC.SDK3.Components.VRCMirrorCamera",
            "VRC.SDK3.Components.VRCOscButtonIn",
            "VRC.SDK3.Components.VRCJukeBox",
            "VRC.SDK3.Components.VRCAddDamage",
            "VRC.SDK3.Components.VRCAddHealth",
            "VRC.SDK3.Components.VRCAvatarCalibrator",
            "VRC.SDK3.Components.VRC_AvatarPedestal",
            "VRC.SDK3.Components.VRCObjectSpawn",
            "VRC.SDK3.Components.VRCObjectSync",
            "VRC.SDK3.Components.VRCPickup",
            "VRC.SDK3.Components.VRCPortalMarker",
            "VRC.SDK3.Components.VRCSlideShow",
            "VRC.SDK3.Components.VRCSpatialAudioSource",
            "VRC.SDK3.Components.VRCStationInput",
            "VRC.SDK3.Components.VRCSyncAnimation",
            "VRC.SDK3.Components.VRCSyncVideoPlayer",
            "VRC.SDK3.Components.VRCSyncVideoStream",
            "VRC.SDK3.Components.VRCVideoScreen",
            "VRC.SDK3.Components.VRCVideoSpeaker",
            "VRC.SDK3.Components.VRCPlayerAudioOverride",
            "VRC.SDK3.Components.VRCMirrorReflection",
            "VRC.SDK3.Components.VRCSceneDescriptor",
            "VRC.SDK3.Components.VRCSceneResetPosition",
            "VRC.SDK3.Components.VRCSceneSmoothShift",
            "VRC.SDK3.Components.VRCStation",
            "VRC.SDK3.Components.VRCStereoObject",
        ...
        //public static IEnumerator RemoveIllegalComponentsEnumerator(GameObject target, WhiteListConfiguration config, bool retry = true)
        //{
        ...
        public static IEnumerator RemoveIllegalComponentsEnumerator(GameObject[] targets, WhiteListConfiguration config, bool retry = true)
        {
            ConfigureWhiteList(config);
            foreach (GameObject target in targets)
                yield return ValidationUtils.RemoveIllegalComponentsEnumerator(target, ValidationUtils.WhitelistedTypes("world"+config.ToString(), ComponentTypeWhiteList), retry, true);
        }

        //public static IEnumerable<Component> FindIllegalComponents(GameObject target, WhiteListConfiguration config)
        //{
        //    ConfigureWhiteList(config);
