 ...
 namespace VRCSDK2.Validation
{
    public static class AvatarValidation
    {
        ...
        public static List<VRC.SDKBase.VRC_Station> EnforceAvatarStationLimits(GameObject currentAvatar)
        {
            List<VRC.SDKBase.VRC_Station> found = new List<VRC.SDKBase.VRC_Station>();
        ...
        public static void StripAnimations(GameObject currentAvatar)
        {
            ...
            foreach (VRC.SDKBase.VRC_Station station in currentAvatar.GetComponentsInChildren<VRC.SDKBase.VRC_Station>(true))
            {
                if (station == null)
                    continue;
